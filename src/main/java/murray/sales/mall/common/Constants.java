 ...
 * @apiNote constant configuration
 *
 */
public class Constants {
    //public final static String FILE_UPLOAD_DIC = "/opt/image/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = "/Volumes/SeaGate/Mac/SmartDevicesSalesSystem-master/src/main/resources/static/goods-img/";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static String MALL_USER_SESSION_KEY = "salesMallUser";//session中user的key
